...
function Register() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#f5f0e8] p-4 relative overflow-hidden">
      ...
      {/* Punaises */}
      <div className="absolute top-8 left-8 w-4 h-4 rounded-full bg-[#b5c1b4] shadow-lg"></div>
      <div className="absolute top-8 right-8 w-4 h-4 rounded-full bg-[#d4836a] shadow-lg"></div>
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="bg-[#faf7f2] rounded-3xl shadow-[0_8px_32px_rgba(74,64,54,0.12)] p-8 border border-[#e8e0d6] relative">
          ...
          {/* Washi tape */}
          <div className="absolute -top-3 left-1/2 -translate-x-1/2 w-24 h-6 bg-[#b5c1b4] opacity-70 rounded-sm rotate-1 shadow-sm"></div>
          <div className="absolute -top-3 left-1/2 -translate-x-1/2 w-20 h-6 bg-[#b5c1b4] opacity-50 rounded-sm -rotate-3 shadow-sm"></div>
            ...
            <div className="relative inline-block">
              ...
              <svg className="absolute -bottom-1 left-0 w-full h-2" viewBox="0 0 200 10">
                <path d="M0,5 Q25,0 50,5 Q75,10 100,5 Q125,0 150,5 Q175,10 200,5" 
                  stroke="#b5c1b4" strokeWidth="2" fill="none" opacity="0.5"/>
              </svg>
            </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 bg-[#d4836a] text-white font-serif font-medium rounded-xl hover:bg-[#c17a6b] transition-all hover:shadow-lg hover:-translate-y-0.5 active:translate-y-0 disabled:opacity-50 disabled:cursor-not-allowed text-sm tracking-wider mt-2"
            >
          ...
          <div className="mt-6 text-center">
            <p className="text-[#8b7a6b] text-sm font-serif">
              déjà un compte ?{' '}
              <Link to="/login" className="text-[#d4836a] hover:text-[#c17a6b] font-medium hover:underline decoration-[#d4836a]/30 underline-offset-4 transition">
                se connecter
              </Link>
            </p>
          </div>

          <div className="absolute -bottom-2 left-1/3 w-12 h-3 bg-[#d4836a] opacity-50 rounded-sm rotate-2"></div>
          <div className="absolute -bottom-2 right-1/3 w-14 h-3 bg-[#b5c1b4] opacity-60 rounded-sm -rotate-1"></div>
        </div>

        <p className="text-center text-[#8b7a6b] text-xs font-serif mt-6 opacity-60">
          ✦ un espace pour créer sans limites ✦
        </p>
      </div>
    </div>
  );
